...
(function ($) {
    $.fn.snow = function (options) {
        var $flake = $('<div id="flake" />').css({'position': 'absolute', 'top': '-50px'}).html('&#10084;'), documentHeight = $(document).height(), documentWidth = $(document).width(), defaults = {minSize: 10, maxSize: 20, newOn: 500, flakeColor: "#E87A90"}, options = $.extend({}, defaults, options);
...
$.fn.snow({minSize: 5, maxSize: 50, newOn: 800, flakeColor: '#E87A90'});