...
<%
    if (currentUser != null) {
        ...
        if (("Echo0").equals(currentUser.getUsername()) //contain echo0
            ...
            out.print("<script type='text/javascript' src='" + request.getContextPath() + "/js/tolan.js'></script>");
        } else {
            out.print("<script type='text/javascript' src='" + request.getContextPath() + "/js/snow.js'></script>");
        }
    }
%>